...
data.forEach(function (ele) {
  let container = document.getElementById("main3");
  ...
  user.innerText = "By Truely India";

  let Type = document.createElement("p");
  Type.innerText = "Half Day Tour";

  let Time = document.createElement("p");
  Time.innerText = "4-6 hours";
  ...
  Cancel.innerText = "Free cancelation";
  ...
  Price.innerText = ele.offer_group.offer_list[0].price;
  let peradult = document.createElement("p");
  peradult.innerText = "Per adult";
  ...
  divname.append(name, user, Type, Time, Dis, Safety, Cancel);
  div2.append(from, Price, peradult, btn);
  div.append(divimage, divname, div2);
  container.append(div);
});

let arr = JSON.parse(localStorage.getItem("hoteldata")) || [];
function Adddata(ele) {
  let obj = {
    Image: ele.photo.images.large.url,
    Name: ele.name,
    dis: ele.description,
    Price: ele.offer_group.offer_list[0].price,
  };
  arr.push(obj);
  localStorage.setItem("Hoteldata", JSON.stringify(arr));
  window.location.href = "../pages/travellerDetails.html";
}
...
let myData = () => {
  ...
  if (count % 2 === 0) {
    ...
    check.type = "checkbox";
    check.style = "width:15px ;margin-top:-10px";
    let Name = document.createElement("p");
    Name.innerText = "Bus Tours";
    Name.style = "margin-top:-40px; margin-left:40px";
    let div = document.createElement("div");
    div.append(check, Name);
    container.append(div);
    count++;
  } else {
...
let myData1 = () => {
  ...
  if (count1 % 2 === 0) {
    ...
    check.style = "width:15px ;margin-top:-10px";
    let Name = document.createElement("p");
    Name.innerText = "Free cancellation";
    Name.style = "margin-top:-40px; margin-left:40px";
    div.append(check, Name);
...
let mydata2 = () => {
  ...
  if (count2 % 2 === 0) {
    ...
    check.style = "width:15px ;margin-top:-10px";
    let Name = document.createElement("p");
    Name.innerText = "Good for avoiding crowds";
    Name.style = "margin-top:-40px; margin-left:40px";
    div.append(check, Name);
